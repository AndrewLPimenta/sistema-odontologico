...
import { SmileIcon as Tooth, Menu, X, LayoutDashboard, Calendar, FileText, Settings, LogOut, Bell } from "lucide-react"
...
export function PatientLayout({ children }: PatientLayoutProps) {
  ...
  const routes = [
    ...
    },
    {
      ...
      icon: Calendar,
      active: pathname.includes("/dashboard/patient/appointments"),
    },
    {
      href: "/dashboard/patient/records",
      label: "Meus Registros",
      icon: FileText,
      active: pathname.includes("/dashboard/patient/records"),
    },
    {
      href: "/dashboard/patient/settings",
      label: "Configurações",
      icon: Settings,
      active: pathname.includes("/dashboard/patient/settings"),
    },
  ]
